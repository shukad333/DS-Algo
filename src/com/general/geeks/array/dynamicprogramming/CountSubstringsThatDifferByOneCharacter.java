...
public class CountSubstringsThatDifferByOneCharacter {
    ...
    public static void main(String[] args) {
        ...
        CountSubstringsThatDifferByOneCharacter countSubstringsThatDifferByOneCharacter = new CountSubstringsThatDifferByOneCharacter();
        int resp = countSubstringsThatDifferByOneCharacter.countSubstrings("aaa","zzz");
