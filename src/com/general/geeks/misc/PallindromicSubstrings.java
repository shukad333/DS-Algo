...
public class PallindromicSubstrings {
	...
	public static void main(String[] args) {
		System.out.println(new PallindromicSubstrings().countSubstrings("aaa"));
	}
	...
	public int countSubstrings(String s) {
		...
		for(int i=0;i<s.length();i++) {
			count+=extendPallindrome(s, i, i);
			count+=extendPallindrome(s, i, i+1);
		}
		return count;
	}
	
	private int extendPallindrome(String s , int start , int end) {
		int count = 0;
