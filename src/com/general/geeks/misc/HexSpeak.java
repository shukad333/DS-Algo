 ...
 * occurrences of the digit 0 with the letter O, and the digit 1 with the letter
 * I. Such a representation is valid if and only if it consists only of the
 ...
 * Constraints:
 * 
 * 1 <= N <= 10^12 There are no leading zeros in the given string. All answers
 * must be in uppercase letters. Accepted
 * 
 * @author skadavath
 *
 */
