 ...
 * undirected graph will be like this: 1 / \ 2 - 3 Example 2: Input: [[1,2],
 * [2,3], [3,4], [1,4], [1,5]] Output: [1,4] Explanation: The given undirected
 * graph will be like this: 5 - 1 - 2 | | 4 - 3 Note: The size of the input
 * 2D-array will be between 3 and 1000. Every integer represented in the
 * 2D-array will be between 1 and N, where N is the size of the input array.
 * 
 ...
 *
 */
public class ReduntantGraph {
	
	public static void main(String[] args) {
		int[][] edges = new int[][] {{1,2},{2,3},{3,4},{1,4},{1,5}};
		System.out.println(Arrays.toString(new ReduntantGraph().findRedundantConnection(edges)));
	}
