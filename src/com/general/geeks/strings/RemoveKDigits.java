...
public class RemoveKDigits {
	...
	public static void main(String[] args) {
		...
		System.out.println(new RemoveKDigits().removeKdigits("11", 3));
	}
	public String removeKdigits(String num, int k) {
		...
		int toCutTrail = 0;
		while(toCutTrail<length && chars[toCutTrail]=='0')
			toCutTrail++;
		return toCutTrail==length?"0":new String(chars,toCutTrail,length-toCutTrail);
