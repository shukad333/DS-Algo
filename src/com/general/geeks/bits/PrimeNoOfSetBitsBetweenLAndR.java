 ...
 * prime) 15 -> 1111 (4 set bits, 4 is not prime)
 * 
 * @author skadavath
 *
 *   10100010100010101100 - 665772
 */
public class PrimeNoOfSetBitsBetweenLAndR {
	
	public static void main(String[] args) {
		System.out.println(new PrimeNoOfSetBitsBetweenLAndR().countPrimeSetBits(10, 15));
	}
